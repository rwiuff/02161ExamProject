...
Programmet kommer med demo-data installeret. Du kan derfor logge ind med følgende initialer; \texttt{kasy}, \texttt{rawi}, \texttt{mach}, \texttt{mash}. En jar-fil kan også oprettes med mvn package, der derefter kan køres. På UNIX-systemer skal den producerede jar-fil gøres eksekverbar med chmod +x [filnavn], såfremt brugeren har de rette privilegier, så den anses som en eksekverbar fil inden forsøg på kørsel.
...
\begin{figure}[H]
    ...
    \dirtree{%
        ...
        .7 components \ldots{} \begin{minipage}[t]{10cm} Genbrugelige CLI komponenter \end{minipage}.
        .7 TaskFusionCLI.java \ldots{} \begin{minipage}[t]{10cm} CLI-hovedklasse \end{minipage}.
        .3 test.
        .4 java.
        .5 taskfusion.
