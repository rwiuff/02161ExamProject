...
\chead{\includegraphics[height=40pt]{ImplementationAndTest/Graphics/DTU}}
...
% \setmuskip{\thinmuskip}{6.0mu}
% \setmuskip{\medmuskip}{8.0mu plus 4.0mu minus 8.0mu}
% \setmuskip{\thickmuskip}{10.0mu plus 10.0mu}
...
\title{\includegraphics[width=.15\textwidth]{ImplementationAndTest/Graphics/DTU}\lb\vspace{.5em}\Huge\scshape\color{DTUred} \titl\lb\vspace{-4mm}\rule{4cm}{0.5mm}\lb\Large{\courseno \ \course}}
...
\newpage
\setcounter{page}{1}
\input{ImplementationAndTest/Sections/00Forfatterskab.tex}
\input{ImplementationAndTest/Sections/01Programstruktur.tex}
\input{ImplementationAndTest/Sections/02WhiteBoxTest.tex}
\input{ImplementationAndTest/Sections/03CodeCoverage.tex}
\input{ImplementationAndTest/Sections/04DesignByContract.tex}
\input{ImplementationAndTest/Sections/05Design.tex}
\input{ImplementationAndTest/Sections/06SOLID}
\input{ImplementationAndTest/Sections/07Konklusion.tex}
...
\listoflistings
%Appendicer herunder:
\input{ImplementationAndTest/Sections/Appendix.tex}
