...
Scenario: 1. Register an employee
    ...
    And there is an employee with first name "Michael", last name "Laudrup" and initials "mila"  
...
Scenario: 1b. Initials is required to register an employee
    Given a guest is logged in
    And there is a employe with first name "Michael", last name "Laudrup" and initials ""
    When the user registers the employee
...
Scenario: 2a. Employees with same name can be registered
    ...
    And there is a employe with first name "Michael", last name "Laudrup" and initials "milb" 
    When the user registers the employee
    Then an employee with first name "Michael", last name "Laudrup" and initials "milu" exists in the application
    \end{minted}
\end{listing}\newpage
\textbf{Log in}
\begin{listing}[H]
...
Scenario: 1. Creating a project
    ...
    Then a project with title "Projektplanlægning", project number 23001 exists in the application
...
Scenario: 1c. An employee can self assign as projectleader on a project
    Given an employee is logged in
...
Scenario: 1. Creating a project activity
    ...
    And there is a project activity with the title "Graphic design"  
    When the user assigns the project activity to project 23001 
    Then the project with the project number 23001 has a project activity titled "Graphic design" 
...
Scenario: 2. A time budget can be added to a project activity
    ...
    When the user sets the time budget to 50 hours on the project activity with the title "Graphic design" and project number 23001
    Then the project activity with the title "Graphic design", project number 23001, has a time budget of 50 hours 

Scenario: 3. A start week can be set to a project activity
    Given the user is logged in as "mila"
    And an activity with the title "Graphics design" exists within the project with project number 23001
    When the user sets the start week to 2304 on the project activity with the title "Graphic design" on the project with project number 23001
    Then the project activity with the title "Graphic design", project number 23001 has start week 2304

Scenario: 4. An end week can be set to a project activity
    Given the user is logged in as "mila"
    And an activity with the title "Graphics design" exists within the project with project number 23001
    When the user sets the end week to 2304 on the project activity with title "Graphic design" on the project with project number 23001
    Then the project activity with title "Graphic design", project number 23001 has end week 2304
    \end{minted}
\end{listing}
\begin{listing}[H]
    \centering
...
Scenario: 2a. A guest is not able to set a time budget on a project activity
    ...
    When the user sets the time budget to 50 hours on the project activity with the title "Graphic design", project number 23001
    Then the error message "Login krævet" is given

Scenario: 3a. A guest is not able to set a start week on a project activity
    Given the user is logged in as "mila"
    And an activity with the title "Graphics design" exists within the project with project number 23001
    When the user sets the start week to 2304 on the project activity with the title "Graphic design", project number 23001
    Then the error message "Login krævet" is given

Scenario: 3b. A start week needs to be before or the same as the end week
    Given the user is logged in as "mila"
    And an activity with the title "Graphics design" exists within the project with project number 23001
    When the user sets the start week to 2304, the end week to 2303 on the project activity with the title "Graphic design" on the project with project number 23001
...
Scenario: 4a. A guest is not able to set an end week on a project activity
    Given the user is logged in as "mila"
    And an activity with the title "Graphics design" exists within the project with project number 23001
    When the user sets the end week to 2304 on project activity with the title "Graphic design" on the project with project number 23001
    Then the error message "Login krævet" is given

Scenario: 4b. An end week needs to be after or same as start week
    Given the user is logged in as "mila"
    And an activity with the title "Graphics design" exists within the project with project number 23001
    When the user sets the start week to 2304, end week to 2303 on the project activity with the title "Graphic design" on the project with project number 23001
...
Scenario: 1. A project leader can create a project activity
    ...
    And there is a project activity with the title "Graphic design"  
    When the user creates the project activity in the application 
    Then the project with project number 23001 has a project activity with title "Graphic design" 
...
Scenario: 1. Register work time on project activity
    ...
    Then the user has 6 hours of registered work time on the project activity with title "Graphics design", project number 23001
...
\begin{listing}[H]
    ...
    \begin{minted}[breaklines]{gherkin}  
# !!! FORSLAG !!! (kasper)
Feature: View work time on a project activity
Description: An employee registers work time on a project activity.
Actors: employee

#BACKGROUND
Background:
    Given there is an employee in the application with first name "Michael", last name "Laudrup" and initials "mila"
    And a project with the title "Video game", project number of 23001 exists in the application
    And an activity with the title "Graphics design" exists within the project titled "Video Game"
    And the employee with initials "mila" has registered a work time of 6 hours on the project activity with title "Graphics design" in the project with project number 23001
    And the employee with initials "mila" has registered a work time of 10 hours to the project activity with title "Graphics design" in the project with project number 23001

#MAIN SCENARIOS
Scenario: 1. Employee can get a list of work time registrations for a project activity
    Given the user is logged in as "mila"
    When a list of registered work time registrations is requested for the activity titled "Graphics design" in the project with project number 23001
    Then a list with 2 items is returned

Scenario: 2. Employee can get a total of work time registrations for a project activity
    Given the user is logged in as "mila"
    When a total of registered work time is requested for the activity titled "Graphics design" in the project with project number 23001
    Then 16 hours is returned

#ALTERNATIVE SCENARIOS
Scenario: 1a. Guests is unable to get a list of work time registrations for a project activity
    Given a guest is logged in
    When a list of registered work time registrations is requested for the activity titled "Graphics design" in the project with project number 23001
    Then the error message "Login kræves" is given

Scenario: 2a. Guests is unable to get a total of work time registrations for a project activity
    Given a guest is logged in
    When a total of registered work time is requested for the activity titled "Graphics design" in the project with project number 23001
    Then the error message "Login kræves" is given
    \end{minted}
...
Feature: View summary of registered work time pr. activity
    Description: A project leader can view a summary of registered work time pr. activity
