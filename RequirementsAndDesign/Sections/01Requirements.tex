...
\begin{table}[H]
    ...
    \begin{tabular}{lll}
        ...
        Opret Aktivitet for projekt med projektleder         & \cpageref{lst:usecase_project_activity_with_leader}                                                                                              &   \cref{fig:sequence_create_PA_guest}, \cref{fig:sequence_create_PA_no_PL_1}, \cref{fig:sequence_create_PA_no_PL_2} på \cpageref{fig:sequenceRegisterEmployee}                                                                             \\
