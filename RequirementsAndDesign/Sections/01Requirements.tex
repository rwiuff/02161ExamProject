...
\begin{table}[H]
    ...
    \begin{tabular}{lll}
        ...
        Opret Aktivitet for projekt uden projektleder        & \cpageref{lst:usecase_project_activity_no_leader_1,lst:usecase_project_activity_no_leader_2}                                                     &        \cref{fig:sequence_create_PA_guest}, \ref{fig:sequence_create_PA_no_PL_1}, \ref{fig:sequence_create_PA_no_PL_2}, \ref{fig:sequence_create_PA_no_PL_3}, \ref{fig:sequence_create_PA_no_PL_4} på \cpageref{fig:sequence_create_PA_guest} - \pageref{fig:sequence_create_PA_no_PL_4}                                                                            \\
        Opret Aktivitet for projekt med projektleder         & \cpageref{lst:usecase_project_activity_with_leader}                                                                                              &        \cref{fig:sequence_create_PA_PL} \cpageref{fig:sequence_create_PA_PL}                                                                   \\
