...
Dette afsnit starter med \cref{fig:AlleActorsPaaEnGang} som viser hvilke aktører der kan udfører hvilke cases. Herefter kommer en oversigt (\cref{tbl:oversigt}) over de detajlerede use cases og hvilke sider der indeholder Cucumber features (\cpagerefrange{lst:usecase_register_employee}{lst:remainingTime}) og sekvensdiagrammer (\cref{sec:sequence}).
\begin{figure}[H]
    \centering
...
\begin{table}[H]
    ...
    \begin{tabular}{lll}
        ...
        \midrule
        Opret Medarbejder                                    & \cpageref{lst:usecase_register_employee}                                                                                                         & \cref{fig:sequence_register_employee1,fig:sequence_register_employee2} på \cpageref{fig:sequence_register_employee1,fig:sequence_register_employee2} \\
        ...
        Opret Aktivitet for projekt med projektleder         & \cpageref{lst:usecase_project_activity_with_leader}                                                                                              &                                                                                                                                                      \\
        ...
        FORSLAG: Registrer arbejdstid på projekt aktivitet   & \cpageref{lst:usecase_register_worktime_projectactivity}                                                                                         &                                                                                                                                                      \\
        ...
        Se oversigt over arbejdstid pr. aktivitet og projekt & \cpageref{lst:usecase_oversigt_over_registreret_arbejdstid_pr_aktivitet}                                                                         &                                                                                                                                                      \\
