...
\captionof{listing}{Use case: Opret medarbejder}\label{lst:usecase_register_employee}
...
\captionof{listing}{Use case: Medarbejder log in}\label{lst:usecase_login}
    \begin{minted}[breaklines]{gherkin}  
...
\captionof{listing}{Use case: Medarbejder log ud}\label{lst:usecase_logout}
\begin{minted}[breaklines]{gherkin}  
...
\captionof{listing}{Use case: Opret projekt}\label{lst:usecase_create_project}
    \begin{minted}[breaklines]{gherkin}  
...
\captionof{listing}{Use case: Opret fast aktivitet}\label{lst:usecase_regular_activity}
    \begin{minted}[breaklines]{gherkin}  
...
\captionof{listing}{Use case: Opret projekt aktivitet for projekt uden projektleder.} \label{lst:usecase_project_activity_no_leader}
    \begin{minted}[breaklines]{gherkin}  
...
\captionof{listing}{Use case: Opret projekt aktivitet for projekt med projektleder} \label{lst:usecase_project_activity_with_leader}
    \begin{minted}[breaklines]{gherkin}  
...
\captionof{listing}{Use case: Medarbejder udpeger sig som projektleder} \label{lst:usecase_bliv_projektleder}
    \begin{minted}[breaklines]{gherkin}  
...
\captionof{listing}{Use case: Registrer arbejdstid på projekt aktivitet} \label{lst:usecase_register_worktime_projectactivity}
    \begin{minted}[breaklines]{gherkin}  
# !!! FORSLAG !!! (kasper)
...
\captionof{listing}{Use case: Se registreret arbejdstid på projekt aktivitet} \label{lst:usecase_view_worktime_projectactivity}
    \begin{minted}[breaklines]{gherkin}  
# !!! FORSLAG !!! (kasper)
...
\captionof{listing}{Use case: Se og rediger i registreret arbejdstid på aktivitet}\label{lst:usecase_se_og_rediger_i_registreret_arbejdstid_paa_aktivitet}
    \begin{minted}[breaklines]{gherkin}  
...
\captionof{listing}{Use case: Se og rediger i registreret arbejdstid på aktivitet}\label{lst:usecase_oversigt_over_registreret_arbejdstid_pr_aktivitet}
    \begin{minted}[breaklines]{gherkin}  
...
\captionof{listing}{Budgetteret tid til aktivitet}\label{lst:budget_time}
    \begin{minted}[breaklines]{gherkin}
...
\captionof{listing}{Tilknyt medarbejder}\label{lst:assign_employ}
    \begin{minted}[breaklines]{gherkin}
...
\captionof{listing}{Hent restarbejde}\label{lst:remainingTime}
    \begin{minted}[breaklines]{gherkin}
...
\captionof{listing}{Cucumber feature 1}\label{lst:feature1}
    \begin{minted}[breaklines]{gherkin}
    Feature: Buy fruit
    ...
    Scenario: Buy a fruit with enough money
        ...
        ...
    \end{minted}
\captionof{listing}{Cucumber feature 2}\label{lst:feature2}
    \begin{minted}[breaklines]{gherkin}
    Feature: Buy fruit
    Description: A user buys fruit...
    Actors: User
