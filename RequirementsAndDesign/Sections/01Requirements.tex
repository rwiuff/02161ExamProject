...
\begin{listing}[H]
    ...
    \inputminted[linenos, breaklines]{cucumber}{TaskFusion/features/projects/get_list_participating_employees.feature}
\end{listing}
\begin{listing}[H]
    \centering
    \caption{Cucmber feature: Opret projektaktivitet som projektleder}\label{lst:usecaseCreateProjectActivityPL}
    \inputminted[linenos, breaklines]{cucumber}{TaskFusion/features/activities/create_project_activity_with_leader.feature}
\end{listing}
\begin{listing}[H]
    \centering
    ...
    \inputminted[linenos, breaklines, lastline=46]{cucumber}{TaskFusion/features/activities/create_project_activity_without_leader.feature}
\end{listing}
\begin{listing}[H]
    \centering
    ...
    \inputminted[linenos, breaklines, firstline=47]{cucumber}{TaskFusion/features/activities/create_project_activity_without_leader.feature}
\end{listing}
\begin{listing}[H]
    \centering
    \caption{Cucmber feature: Anfør tidsbudget på projektaktivitet}\label{lst:usecaseSetTimeBudget}
    \inputminted[linenos, breaklines]{cucumber}{TaskFusion/features/activities/activity_work_time_budget.feature}
\end{listing}
\begin{listing}[H]
    \centering
    ...
    \inputminted[linenos, breaklines, lastline=16]{cucumber}{TaskFusion/features/regular_activities/create_regular_activity.feature}
\end{listing}
\begin{listing}[H]
    \centering
    ...
    \inputminted[linenos, breaklines, firstline=17]{cucumber}{TaskFusion/features/regular_activities/create_regular_activity.feature}
\end{listing}
\begin{listing}[H]
    \centering
    \caption{Cucumber feature: Se fast aktivitet}\label{lst:usecaseViewRegularActivity}
    \inputminted[linenos, breaklines]{cucumber}{TaskFusion/features/regular_activities/view_regular_activity.feature}
\end{listing}
\begin{listing}[H]
    \centering
    ...
    \inputminted[linenos, breaklines, lastline=33]{cucumber}{TaskFusion/features/activities/register_activity_work_time.feature}
\end{listing}
\begin{listing}[H]
    \centering
    ...
    \inputminted[linenos, breaklines, firstline=34]{cucumber}{TaskFusion/features/activities/register_activity_work_time.feature}
\end{listing}
\begin{listing}[H]
    \centering
    \caption{Cucumber feature: Se resterende arbejdstid}\label{lst:RemainingWork}
    \inputminted[linenos, breaklines]{cucumber}{TaskFusion/features/activities/activity_remaining_work.feature}
\end{listing}
\begin{listing}[H]
    \centering
    ...
    \inputminted[linenos, breaklines, lastline=44]{cucumber}{TaskFusion/features/activities/overview_work_time.feature}
\end{listing}
\begin{listing}[H]
    \centering
    ...
    \inputminted[linenos, breaklines, firstline=45]{cucumber}{TaskFusion/features/activities/overview_work_time.feature}
\end{listing}
\begin{listing}[H]
    \centering
    \caption{Cucmber feature: Generér projektrapport (fortsætter på \cref{lst:usecaseGenerateProjectReport2})}\label{lst:usecaseGenerateProjectReport1}
    \inputminted[linenos, breaklines, lastline=32]{cucumber}{TaskFusion/features/reports/create_report.feature}
\end{listing}
\begin{listing}[H]
    \centering
    \caption{Cucmber feature: Generér projektrapport (fortsat fra \cref{lst:usecaseGenerateProjectReport1})}\label{lst:usecaseGenerateProjectReport2}
    \inputminted[linenos, breaklines, firstline=33]{cucumber}{TaskFusion/features/reports/create_report.feature}
\end{listing}
