...
\newcommand{\titl}{Eksamensprojekt}
\newcommand{\handin}{Indsæt dato}
\newcommand{\authOne}{Rasmus Wiuff}
\newcommand{\authTwo}{Rasmus Wiuff}
\newcommand{\authThree}{Rasmus Wiuff}
...
\definecolor{bg}{cmyk}{.04, .08, .0, .9}
\newcommand{\im}[3]{\inputminted[bgcolor=bg, linenos=true, python3=true, firstline=#2, lastline=#3]{python}{#1}}
\newcommand{\java}[3]{\inputminted[bgcolor=bg, linenos=true, firstline=#2, lastline=#3]{java}{#1}}
\usepackage{dirtree}
...
\preauthor{\begin{center}
    ...
    \begin{tabular}[t]{r}}
\author{\textbf{Afleverinsgruppe 13:} \lb \lb \authOne \ \textbf{\SIDOne} \lb \authTwo \ \textbf{\SIDTwo} \lb \authThree \ \textbf{\SIDThree} \lb \authFour \ \textbf{\SIDFour} \lb \href{LINK}{\color{DTUred}LINK}\github{LINK}}
